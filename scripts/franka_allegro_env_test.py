...
def load_and_preprocess_dataset(dataset_name: str, camera_id: str) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
    """
    ...
    """
    ref_obj_traj, ref_hand_keypoints_traj = load_dataset(name=dataset_name, camera_id=camera_id)
...
def perform_kinematic_retargeting(
    ...
    optimized_hand_keypoints = kinematic_retargeting.optimization.forward_kinematics_evaluator(sol)
...
def main(cfg: DictConfig):
    ...
    ref_obj_traj, ref_hand_keypoints_traj_original, ref_hand_keypoints_traj = load_and_preprocess_dataset(dataset_name, camera_id)
    
    # Setup environment
    env, _ = setup_environment(cfg)
    
    # Generate trajectory
    x_traj = generate_trajectory(env, ref_hand_keypoints_traj, ref_hand_keypoints_traj_original, ref_obj_traj)
